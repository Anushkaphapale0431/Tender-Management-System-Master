...
<div class="footer">    
  <div class="navbar navbar-inverse" style="border-radius: 0px ;margin-bottom:0px">
          <div class="container-fluid ">
              ...
              <br>
              <!-- Developer 1 Ms. Anushka Phapale-->
                <div class="col-md-3 col-xs-12 col-sm-3" >
                  <div class="col-md-5 col-xs-5 col-sm-5">
                    <img src="images/Anushka.jpeg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="Shashi Raj Site Developer" title="Mr. Shashi Raj"/>
                  </div>
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:red">Ms. Anushka Phapale</span>
<!--                     <p><span>Web Developer</span></p>
 -->                    <p>MCA-141</p>
              ...
              <!-- Developer 2 Ms. Madhavi Tripathi -->
                <div class="col-md-2 col-xs-12 col-sm-2">
                  <div class="col-md-5 col-xs-5 col-sm-5">
                    <img src="images/Madhavi.jpeg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="Ahana Guchait Site Developer" title="Mr. Ahana Guchait">
                  </div>
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:red">Ms. Madhavi Tripathi</span>
<!--                     <p><span>Web Designer</span></p>
 -->                    <p>MCA-142</p>
              ...
              <!-- Developer 3 Ms. Komal Selokar -->
              <div class="col-md-2 col-xs-12 col-sm-2">
                <div class="col-md-5 col-xs-5 col-sm-5">
                  <img src="images/Komal.jpeg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="Deep Shikha Site Developer" title="Mr. Deep shikha">
                </div>
                <div class="col-md-7 col-xs-7 col-sm-7">
                  <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                  <br/>
                  <span style="font-size: 1.7em; color:red">Ms. Komal Selokar</span>
<!--                   <p><span>Web Designer</span></p>
 -->                  <p>MCA-143</p>
                  </div>
                </div>
